...
export class AppComponent implements OnInit {
  ...
  submit() {
    ...
    this.canvasContainer.nativeElement.append(
      render(document.createElement('canvas'), TWITTER_POST_WIDTH, TWITTER_POST_HEIGHT, this.form.value, 'twitter')
    );
    // MEETUP
    this.canvasContainer.nativeElement.append(
      render(document.createElement('canvas'), MEETUP_FEATURE_WIDTH, MEETUP_FEATURE_HEIGHT, this.form.value, 'meetup')
    );
    // FACEBOOK
    this.canvasContainer.nativeElement.append(
      render(document.createElement('canvas'), FACEBOOK_POST_WIDTH, FACEBOOK_POST_HEIGHT, this.form.value, 'facebook')
    );
  }
